  ...
  return (
    <div className="bg-white text-neutral-900 dark:bg-neutral-950 dark:text-white font-sans">
      ...
      <nav className="flex justify-between items-center max-w-7xl mx-auto px-6 py-5 border-b border-neutral-200 dark:border-neutral-800">
        ...
        <Button  className="bg-indigo-600 hover:bg-indigo-700" onClick={() => navigate("/register")}>Get Started</Button>
      </nav>
      ...
      <header className="relative overflow-hidden bg-gradient-to-b from-neutral-50 to-white dark:from-neutral-900 dark:to-neutral-950">
        <div className="max-w-7xl mx-auto px-6 pt-24 pb-40 text-center">
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight">
            All Your <span className="text-indigo-600">AI Tools</span> in One Place
          </h1>
          <p className="mt-6 text-lg text-neutral-600 dark:text-neutral-300 max-w-2xl mx-auto">
            Boost productivity with instant AI-powered summarization, translation,
            code explanation, and image generation — built for speed and simplicity.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <Button className="bg-indigo-600 hover:bg-indigo-700" onClick={() => navigate("/register")}>Try for Free</Button>
            <a href="#features"><Button className="bg-neutral-200 text-neutral-900 hover:bg-neutral-300 dark:bg-neutral-800 dark:hover:bg-neutral-700">
              Learn More
            </Button></a>
          </div>
        </div>
      ...
      <section id="features" className="py-24 bg-neutral-50 dark:bg-neutral-900">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              { icon: Zap, title: "Fast", desc: "Lightning-fast AI responses with minimal wait time." },
              { icon: Code, title: "Code Explainer", desc: "Understand complex code in plain English." },
              { icon: Image, title: "Image Generator", desc: "Turn text prompts into stunning visuals." },
              { icon: Languages, title: "Translator", desc: "Translate text into 50+ languages instantly." }
      ...
      <section id="pricing" className="py-24">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { plan: "Free", price: "$0", features: ["5 requests/day", "Basic AI tools"] },
              { plan: "Pro", price: "$19/mo", features: ["Unlimited requests", "All AI tools", "Priority support"] },
              { plan: "Enterprise", price: "Custom", features: ["Custom AI models", "Dedicated account manager"] }
      ...
      >
        ...
        <p className="mt-4">Join thousands of developers and teams using AI to supercharge their work.</p>
